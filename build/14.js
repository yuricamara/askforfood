...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cart_step1__ = __webpack_require__(629);
        ...
        this.cartService
            ...
            productsSubscription.forEach(function (productSubscription) {
                productSubscription
                    ...
                    _this.cartService.setCartContent(cartContent);
                    // Visualizaçao da página
                    if (_this.loading) {
